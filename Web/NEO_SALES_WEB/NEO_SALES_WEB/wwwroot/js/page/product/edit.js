(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var loadingEl = document.getElementById("neoProductFormLoading");
        ...
        apiFetch("GET", "/bff/product/" + id).then(function (res) {
            ...
            stockInput.value = res.data.stock;
        ...
        form.addEventListener("submit", function (evt) {
            ...
            apiFetch("PUT", "/bff/product/" + id, payload).then(function (res) {
